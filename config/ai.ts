...
export interface Env {
  ...
  MOCK_MODE?: string
  OMNIPOST_TWITTER_CLIENT_ID?: string
  OMNIPOST_TWITTER_CLIENT_SECRET?: string
  OMNIPOST_LINKEDIN_CLIENT_ID?: string
  OMNIPOST_LINKEDIN_CLIENT_SECRET?: string
  OMNIPOST_MASTODON_CLIENT_ID?: string
  OMNIPOST_MASTODON_CLIENT_SECRET?: string
  OMNIPOST_THREADS_CLIENT_ID?: string
  OMNIPOST_THREADS_CLIENT_SECRET?: string
  OMNIPOST_REDDIT_CLIENT_ID?: string
  OMNIPOST_REDDIT_CLIENT_SECRET?: string
  OMNIPOST_GOOGLE_CLIENT_ID?: string
  OMNIPOST_GOOGLE_CLIENT_SECRET?: string
  OMNIPOST_PINTEREST_CLIENT_ID?: string
