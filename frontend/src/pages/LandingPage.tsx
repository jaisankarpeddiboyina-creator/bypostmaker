...
export default function LandingPage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      gens: 50,
      platforms: 13,
      features: ['50 generations/month', '13 platforms', '30-day history', 'AI refinement'],
    },
    {
      key: 'pro',
      name: 'Pro',
      price: { usd: '$19', inr: '₹1,499' },
      gens: 200,
      platforms: 20,
      features: ['200 generations/month', '20 platforms', '90-day history', 'Priority generation'],
      featured: true,
    },
    {
      key: 'business',
      ...
      gens: -1,
      platforms: 33,
      features: ['Unlimited generations', 'All 33 platforms', '1-year history', 'API access (v2)'],
    },
  ]
