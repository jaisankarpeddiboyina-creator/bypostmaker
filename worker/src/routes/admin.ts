...
export async function handleAdmin(
  ...
  if (path === '/api/admin/tasks') {
    const tasksData = [
      {"id":"P1-01","title":"Stabilize core product","phase":"Phase 1 — Launch","type":"Core","priority":"Critical","status":"Not Started","path":"docs/tasks/phases/phase-1-launch/core/P1-01-stabilize-core-product.md"},
      ...
      {"id":"P1-03","title":"Performance optimization pass","phase":"Phase 1 — Launch","type":"Core","priority":"High","status":"Not Started","path":"docs/tasks/phases/phase-1-launch/core/P1-03-performance-optimization-pass.md"},
      {"id":"P1-04","title":"Complete Razorpay international payments","phase":"Phase 1 — Launch","type":"Core","priority":"Critical","status":"Not Started","path":"docs/tasks/phases/phase-1-launch/core/P1-04-complete-razorpay-international-payments.md"},
      {"id":"P1-05","title":"Build subscription flow","phase":"Phase 1 — Launch","type":"Core","priority":"Critical","status":"Not Started","path":"docs/tasks/phases/phase-1-launch/core/P1-05-build-subscription-flow.md"},
      {"id":"P1-06","title":"Improve AI provider reliability/routing","phase":"Phase 1 — Launch","type":"Core","priority":"High","status":"Completed","path":"docs/tasks/phases/phase-1-launch/core/P1-06-improve-ai-provider-reliability-routing.md"},
      {"id":"P1-07","title":"Support higher AI rate limits","phase":"Phase 1 — Launch","type":"Core","priority":"Medium","status":"Completed","path":"docs/tasks/phases/phase-1-launch/core/P1-07-support-higher-ai-rate-limits.md"},
      ...
      {"id":"P1-09","title":"Strengthen fallback architecture","phase":"Phase 1 — Launch","type":"Core","priority":"High","status":"Completed","path":"docs/tasks/phases/phase-1-launch/core/P1-09-strengthen-fallback-architecture.md"},
      {"id":"P1-10","title":"Set up production monitoring & logging","phase":"Phase 1 — Launch","type":"Core","priority":"High","status":"Verified and fully closed.","path":"docs/tasks/phases/phase-1-launch/core/P1-10-set-up-production-monitoring-logging.md","commitHash":"3e34d01"},
      ...
      {"id":"P2-09","title":"Tool: Logo Generator","phase":"Phase 2 — Creator Experience","type":"Optional","priority":"Medium","status":"Not Selected","path":"docs/tasks/phases/phase-2-creator-experience/optional-tools-pool/P2-09-tool-logo-generator.md"},
      ...
      {"id":"P2-11","title":"Tool: Object Remover","phase":"Phase 2 — Creator Experience","type":"Optional","priority":"Medium","status":"Not Selected","path":"docs/tasks/phases/phase-2-creator-experience/optional-tools-pool/P2-11-tool-object-remover.md"},
      {"id":"P2-12","title":"Tool: Upscaler","phase":"Phase 2 — Creator Experience","type":"Optional","priority":"Medium","status":"Not Selected","path":"docs/tasks/phases/phase-2-creator-experience/optional-tools-pool/P2-12-tool-upscaler.md"},
      {"id":"P2-13","title":"Tool: Voice Tools","phase":"Phase 2 — Creator Experience","type":"Optional","priority":"Medium","status":"Not Selected","path":"docs/tasks/phases/phase-2-creator-experience/optional-tools-pool/P2-13-tool-voice-tools.md"},
      ...
      {"id":"P2-16","title":"Platform Workspace — platform previews","phase":"Phase 2 — Creator Experience","type":"Core","priority":"Medium","status":"Not Started","path":"docs/tasks/phases/phase-2-creator-experience/core/P2-16-platform-workspace-platform-previews.md"},
      ...
      {"id":"P3-02","title":"Content scheduling — draft storage","phase":"Phase 3 — Automation","type":"Core","priority":"Medium","status":"Not Started","path":"docs/tasks/phases/phase-3-automation/core/P3-02-content-scheduling-draft-storage.md"},
      ...
      {"id":"P4-05","title":"Client management module","phase":"Phase 4 — Business","type":"Core","priority":"Medium","status":"Not Started","path":"docs/tasks/phases/phase-4-business/core/P4-05-client-management-module.md"},
      {"id":"P4-06","title":"Client approval workflow","phase":"Phase 4 — Business","type":"Core","priority":"Medium","status":"Not Started","path":"docs/tasks/phases/phase-4-business/core/P4-06-client-approval-workflow.md"},
      {"id":"P4-07","title":"Agency workspace features","phase":"Phase 4 — Business","type":"Core","priority":"Medium","status":"Not Started","path":"docs/tasks/phases/phase-4-business/core/P4-07-agency-workspace-features.md"},
      ...
      {"id":"P5-02","title":"AI Video Generation module","phase":"Phase 5 — Scale","type":"Core","priority":"High","status":"Not Started","path":"docs/tasks/phases/phase-5-scale/core/P5-02-ai-video-generation-module.md"},
      {"id":"P5-03","title":"Enterprise features","phase":"Phase 5 — Scale","type":"Core","priority":"Medium","status":"Not Started","path":"docs/tasks/phases/phase-5-scale/core/P5-03-enterprise-features.md"},
      ...
      {"id":"P5-05","title":"Scale infrastructure for 1,000+ users","phase":"Phase 5 — Scale","type":"Core","priority":"Critical","status":"Not Started","path":"docs/tasks/phases/phase-5-scale/core/P5-05-scale-infrastructure-for-1-000-users.md"},
    ]
