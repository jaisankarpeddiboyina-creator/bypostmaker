...
export async function handleAdmin(
  ...
  if (path === '/api/admin/tasks') {
    const tasksData = [
      ...
      {"id":"P1-10","title":"Set up production monitoring & logging","phase":"Phase 1 — Launch","type":"Core","priority":"High","status":"Completed","path":"docs/tasks/phases/phase-1-launch/core/P1-10-set-up-production-monitoring-logging.md","commitHash":"3e34d01"},
