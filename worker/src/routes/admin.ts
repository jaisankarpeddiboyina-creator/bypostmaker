...
export async function handleAdmin(
  ...
  if (path === '/api/admin/tasks') {
    const tasksData = [
      ...
      {"id":"P1-04","title":"Complete Razorpay international payments","phase":"Phase 1 — Launch","type":"Core","priority":"Critical","status":"Completed","path":"docs/tasks/phases/phase-1-launch/core/P1-04-complete-razorpay-international-payments.md"},
